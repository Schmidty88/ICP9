...
# Improvement to the Linear Regression with new Smoking data set
...
# Plotting the linear regression of the form: Y = X1*W1 + X2*W2+b
# X1 is Smoking Status, X2 is Age classification
